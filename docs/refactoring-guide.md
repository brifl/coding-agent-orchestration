...
This guide is intended to inspire ideas and frame the scope and direction of a refactoring effort. It explains what to look for, why the "smell" is a problem, and gives some ideas on what to do about it. Use your own best judgement over this guide, but use this guide as a baseline for finding and fixing problems.
