...
Compatibility wrapper that runs vibe-run with the continuous-refactor workflow.
"""
...
def _sibling_vibe_run() -> Path:
    # .../.codex/skills/continuous-refactor/scripts/continuous_refactor.py
...
def main() -> int:
    ap = argparse.ArgumentParser(prog="continuous_refactor.py")
    ...
    cmd = [sys.executable, str(vibe_run_script), "--repo-root", str(repo_root), "--workflow", "continuous-refactor"]
    if args.catalog:
